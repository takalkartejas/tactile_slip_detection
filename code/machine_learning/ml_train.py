...
class create_network():
    ...
    def evaluate(self, data_loader):
        # Initialize lists for validation
        all_val_features = []
        all_val_labels = []
        ...
        for batch_features, batch_labels in data_loader:
            ...
            all_val_features.append(batch_features_flat)
            all_val_labels.append(batch_labels.numpy())

        # Concatenate the validation features and labels
        ...
        all_predictions = np.array(val_predictions)
